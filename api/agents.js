...
export default async function handler(req) {
  ...
  try {
    ...
    const agentNames = agents || ['clinical', 'financial', 'ops', 'engagement'];
    const results = {};
